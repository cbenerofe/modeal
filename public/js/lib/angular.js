/**
 * @license AngularJS v1.3.0-local+sha.b2e48e6
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.b2e48e6/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.b2e48e6',    // all of these placeholder strings will be replaced by grunt's
